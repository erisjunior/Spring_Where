...
// import com.erisvan.where.rest.dto.InformacaoItemPedidoDTO;
// import com.erisvan.where.rest.dto.InformacoesPedidoDTO;
...
// .map(p -> converter(p))
// .orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND, "Pedido
// não encontrado."));
// }
